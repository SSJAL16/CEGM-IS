...
const BackOrder = () => {
  ...
  const getAllBackOrders = async () => {
    try {
      const res = await backorderService.getBackorderProducts();
  ...
  const handleGenerateBO = (backorder) => {
    ...
    <>
      <div className="right-content w-100">
        ...
        <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 2 }}>
          ...
          >
            <AlertTitle sx={{ fontWeight: 'bold' }}>Generate Backorder</AlertTitle>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <Typography>
                This page displays purchase orders that contain products requiring backorder. You can generate a backorder for approved POs using the "GENERATE BO" button in the actions column.
              </Typography>
            </Box>
          </Alert>
            ...
            <table className="table table-bordered table-striped v-align">
              ...
              <tbody>
                {displayedBackorders.length > 0 ? (
                  displayedBackorders.map((po, index) => (
                    <tr key={po._id}>
                      <td>
                        ...
                        <div className="d-flex align-items-center productBox">
                          <div className="imgWrapper">
                            <Avatar sx={{ bgcolor: deepPurple[500] }}>
                              {po.supplier.company_name?.charAt(0)}
                            </Avatar>
                          </div>
                      ...
                      <td>
                        <div style={{ 
                          ...
                          <Button
                            ...
                            onClick={() => handleViewBackOrder(po)}
                            sx={{ 
                              minWidth: 'auto', 
                              px: 2,
                              py: 1
                          ...
                          {po.order_status === "Approved" ? (
                            ...
                            <Button 
                              variant="contained" 
                              color="secondary"
                              onClick={() => handleOpenArchive(po._id)}
                              sx={{ 
                                minWidth: 'auto', 
                                px: 2,
                                py: 1
                  ...
                  <tr>
                    <td colSpan={7} className="text-center">
                      No purchase orders available for backorder generation.
                    </td>
                  </tr>
                )}
              </tbody>
