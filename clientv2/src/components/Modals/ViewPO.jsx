...
const ViewPO = ({ open, handleClose, po }) => {
  ...
  return (
    <Modal
      ...
      aria-labelledby="po-details-modal"
      aria-describedby="po-details-description"
      sx={{
        display: 'flex',
        alignItems: 'center',
          ...
          <Paper elevation={0} sx={{ bgcolor: 'background.paper', borderRadius: 2, position: 'relative', mb: 3 }}>
            ...
            <Box sx={{ mb: 4, textAlign: 'center' }}>
              ...
              <Chip
                ...
                sx={{
                  bgcolor: getStatusColor(po.order_status),
                  color: 'white',
                  fontSize: '1rem',
                  py: 0.5,
                }}
                ...
                <Card variant="outlined" sx={{ height: '100%' }}>
                  <CardContent>
                    ...
                    <Typography variant="body1" gutterBottom>
                      <strong>PO ID:</strong> {generateCustomPurchaseOrderId(po._id)}
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
              ...
              <Grid item xs={12} md={6}>
                <Card variant="outlined" sx={{ height: '100%' }}>
                  <CardContent>
                    ...
                    <Typography variant="body1" gutterBottom>
                      <strong>Order Date:</strong> {po.order_date ? new Date(po.order_date).toLocaleDateString() : 'Not set'}
                    </Typography>
                    <Typography variant="body1" gutterBottom>
                      <strong>Created At:</strong> {new Date(po.createdAt).toLocaleDateString()}
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
                ...
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={12} md={6}>
                        <Typography variant="body1" gutterBottom>
                          <strong>Company Name:</strong> {po.supplier.company_name}
                        </Typography>
                        <Typography variant="body1" gutterBottom>
                          <strong>Company Email:</strong> {po.supplier.company_email}
                        </Typography>
                        <Typography variant="body1" gutterBottom>
                          <strong>Contact Person:</strong> {po.supplier.person_name}
                        </Typography>
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <Typography variant="body1" gutterBottom>
                          <strong>Contact Number:</strong> {po.supplier.person_number}
                        </Typography>
                        <Typography variant="body1" gutterBottom>
                          <strong>Address:</strong> {`${po.supplier.company_city}, ${po.supplier.company_province}, ${po.supplier.company_country}`}
                        </Typography>
                      </Grid>
                    </Grid>
                  </CardContent>
                ...
                <Card variant="outlined">
                  <CardContent>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                      <Badge badgeContent={po.items.length} color="primary" sx={{ mr: 2 }}>
